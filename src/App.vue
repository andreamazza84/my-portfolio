    ...
    <v-main>
      ...
      <section id="about-me">
        ...
        <v-container class="text-center">
          <h2 class="display-2 font-weight-bold mb-3">SU DI ME</h2>
          ...
          >
            ...
            <div class="brackets-wrap">
              ...
              specialistica per lo sviluppo di un programma per la valutazione dell'impatto ambientale dei sistemi di produzione
              dell'energia elettrica e cogenerativi alimentati a combustibili rinnovabili. Dopo quest'esperienza ho spostato il mio
              interesse dalla meccanica all'energetica. In questa veste ho lavorato per 6 anni presso l'INFN-CNAF occupandomi 
              principalmente del cooling del centro di calcolo TIER 1 come tecnologo, ruolo trasversale che abbraccia sia la 
            ...
            <p class="brackets-extrems">Boolean Careers sullo sviluppo Front-end e Back-end di siti web.</p>
            </div>
          </v-responsive>
      ...
      <section id="portfolio">
        ...
        <v-container>
          ...
          <v-row>
            <v-col
              v-for="({ src, src_h, text, title }, index) in articles"
              :key="index"
              cols="12"
              md="4"
            >
              <v-img
                ...
                :src="(index === counter)? require(src_h) : require(src)"
                class="project mb-4"
                height="275"
                max-width="100%"
...
export default {
  ...
  data (){ 
    ...
    articles: [
          ...
          {
            src: nativeRequire('@/assets/img/boolean/Boolflix.png'),
            src_h: '@/assets/img/boolean/Boolflix-h.png',
            title: 'Boolflix',
          ...
          },
          {
            ...
            src_h: 'https://images.unsplash.com/photo-1416339442236-8ceb164046f8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1892&q=80',
          ...
          },
          {
            ...
            src_h: 'https://images.unsplash.com/photo-1475938476802-32a7e851dad1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80',
